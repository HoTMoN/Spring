...
<<<<<<< HEAD
  			...
  			//data --> Ajax로 요청을 실행하기 위해 외부에서 입력받아야 하는 값이 있는 경우 전달 json형식으로 만들어서 보낸다. json형식 : {"name":"value","name":"value",....}
  			//success --> Ajax요청해서 성공적으로 데이터를 받으면 처리할 내용을 함수로 표현(익명의 함수) Ajax요청으로 받아온 데이터를 이용해서 뷰를 변경하는 코드 			
  			//dataType --> Ajax요청 후 응답으로 전달받은 데이터의 형식(text, json.....)
